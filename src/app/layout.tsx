...
export const metadata: Metadata = {
  ...
  description: "Discover exclusive luxury vehicles from Mercedes, BMW, Porsche & more. Premium dealership with 30+ years of excellence.",
  keywords: "luxury cars, premium dealership, Mercedes, BMW, Porsche, exclusive vehicles",
  metadataBase: new URL("https://elitemotors.com"),
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Elite Motors - Premium Luxury Cars",
    description: "Experience excellence. Discover the world's finest luxury vehicles.",
    siteName: "Elite Motors",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763564122874-azil547i.jpg",
  ...
  twitter: {
    ...
    title: "Elite Motors - Premium Luxury Cars",
    description: "Exclusive luxury vehicles and premium automotive excellence.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763564122874-azil547i.jpg"]
  }
};
